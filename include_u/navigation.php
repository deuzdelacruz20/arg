  ...
  <nav class="navbar navbar-default" style="width: 100%; border-radius:0%">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../../arg/user/homepage.php">ARG AUTOSIGN SHOP</a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li><a href="#">Link</a></li> -->
          <li class="nav-link"><a href="../../arg/user/homepage.php">Home</a></li>
          <li class="nav-link"><a href="../../arg/user/designTemplates.php">Design Templates</a></li>
          <li class="nav-link"><a href="../../arg/user/schedule.php">Schedules</a></li>
          <!-- <li class="nav-link"><a href="../../arg/php/inventory.php">Inventory</a></li>
          <li class="nav-link"><a href="../../arg/php/transactionHistory.php">Transaction History</a></li> -->
          <li class="nav-link"><a href="../../arg/user/payment.php">Payment</a></li>
          <li class="nav-link"><a href="../../arg/user/about.php">About</a></li>
          <!-- <li class="nav-link"><a href="../../arg/php/earningsAndExpenses.php">Earnings and Expenses</a></li> -->
        </ul>
