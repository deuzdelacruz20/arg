        ...
        <div class="row">
          <div class="col-md-4">
            <div class="about-item text-center" style="margin-bottom: 20px; margin-bottom: 20px; padding: 80px,30px; box-shadow: 0 0 9px rgba(0,0,0 .6);">
              ...
              <h3>Mission</h3>
              <hr>
              <p>We deliver creative Print & Marketing Solutions that make our clients successful. We keep our promises, provide creative solutions, and achieve our client’s goals. </p></p>
            </div>
          </div>
          <div class="col-md-4">
